...
func TestCardPatternQuadrupletWithPairsFactory(t *testing.T) {
	...
	for index, useCase := range useCases {
		p := doudizhu.FactoryCardPatternQuadrupletWithPairs(useCase.cards)
...
func TestCardPatternQuadrupletWithPairsGreeter(t *testing.T) {
	...
	for index, useCase := range useCases {
		p1 := doudizhu.FactoryCardPatternQuadrupletWithPairs(useCase.greeterCards)
		p2 := doudizhu.FactoryCardPatternQuadrupletWithPairs(useCase.cards)
