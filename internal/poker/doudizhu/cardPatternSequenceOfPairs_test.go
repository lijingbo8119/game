...
func TestCardPatternSequenceOfPairsFactory(t *testing.T) {
	...
	for index, useCase := range useCases {
		p := doudizhu.FactoryCardPatternSequenceOfPairs(useCase.cards)
...
func TestCardPatternSequenceOfPairsGreeter(t *testing.T) {
	...
	for index, useCase := range useCases {
		p1 := doudizhu.FactoryCardPatternSequenceOfPairs(useCase.greeterCards)
		p2 := doudizhu.FactoryCardPatternSequenceOfPairs(useCase.cards)
