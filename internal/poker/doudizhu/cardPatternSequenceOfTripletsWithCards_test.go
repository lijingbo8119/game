...
func TestCardPatternSequenceOfTripletsWithCardsFactory(t *testing.T) {
	...
	for index, useCase := range useCases {
		p := doudizhu.FactoryCardPatternSequenceOfTripletsWithCards(useCase.cards)
...
func TestCardPatternSequenceOfTripletsWithCardsGreeter(t *testing.T) {
	...
	for index, useCase := range useCases {
		p1 := doudizhu.FactoryCardPatternSequenceOfTripletsWithCards(useCase.greeterCards)
		p2 := doudizhu.FactoryCardPatternSequenceOfTripletsWithCards(useCase.cards)
