...
func TestCardPatternSequenceOfTripletsWithPairsFactory(t *testing.T) {
	...
	for index, useCase := range useCases {
		p := doudizhu.FactoryCardPatternSequenceOfTripletsWithPairs(useCase.cards)
...
func TestCardPatternSequenceOfTripletsWithPairsGreeter(t *testing.T) {
	...
	for index, useCase := range useCases {
		p1 := doudizhu.FactoryCardPatternSequenceOfTripletsWithPairs(useCase.greeterCards)
		p2 := doudizhu.FactoryCardPatternSequenceOfTripletsWithPairs(useCase.cards)
