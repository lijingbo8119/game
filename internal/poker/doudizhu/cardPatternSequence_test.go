...
func TestCardPatternSequenceFactory(t *testing.T) {
	...
	for index, useCase := range useCases {
		p := doudizhu.FactoryCardPatternSequence(useCase.cards)
...
func TestCardPatternSequenceGreeter(t *testing.T) {
	...
	for index, useCase := range useCases {
		p1 := doudizhu.FactoryCardPatternSequence(useCase.greeterCards)
		p2 := doudizhu.FactoryCardPatternSequence(useCase.cards)
