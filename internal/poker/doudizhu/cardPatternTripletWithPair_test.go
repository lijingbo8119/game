...
func TestCardPatternTripletWithPairFactory(t *testing.T) {
	...
	for index, useCase := range useCases {
		p := doudizhu.FactoryCardPatternTripletWithPair(useCase.cards)
...
func TestCardPatternTripletWithPairGreeter(t *testing.T) {
	...
	for index, useCase := range useCases {
		p1 := doudizhu.FactoryCardPatternTripletWithPair(useCase.greeterCards)
		p2 := doudizhu.FactoryCardPatternTripletWithPair(useCase.cards)
